...
#define MAX_EE_SIZE				   2048//512 //4096
...
#define LENGTH_SENSOR_CAL          56 //Big Endian words storing the no-ball ADC reading for each sensor
#define LENGTH_SENSOR_BASE         56

//#define LENGTH_GPS_VER             6
...
//GPS Version to be stored while updating GPS cfg data
//#define EE_GPS_VER_LOC	               MAX_EE_SIZE - LENGTH_GPS_VER
...
#define EE_WIFI_CONFIG_STATE_LOC    (EE_SENSOR_BASE_LOC - 1)

#define EE_WIFI_OUT_CID_LOC         (EE_WIFI_CONFIG_STATE_LOC - 1)

#define EE_WIFI_IN_CID_LOC          (EE_WIFI_OUT_CID_LOC - 1)
